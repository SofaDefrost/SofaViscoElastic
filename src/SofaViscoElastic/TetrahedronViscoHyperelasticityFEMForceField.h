...
#include <SofaViscoElastic/material/viscohyperelastic/BaseViscoHyperelasticMaterial.h>
...
//Tetrahedron FEM code for several  Visco-Hyperelastic models: Total Lagrangian ForceField

// Compute Finite Element forces based on tetrahedral elements.

template<class DataTypes>
class TetrahedronViscoHyperelasticityFEMForceField : public core::behavior::ForceField<DataTypes>
{
public:
    SOFA_CLASS(SOFA_TEMPLATE(TetrahedronViscoHyperelasticityFEMForceField, DataTypes), SOFA_TEMPLATE(core::behavior::ForceField, DataTypes));
...
protected:
 ...
 public :
    ...
    SingleLink<TetrahedronViscoHyperelasticityFEMForceField<DataTypes>, sofa::core::topology::BaseMeshTopology, BaseLink::FLAG_STOREPATH | BaseLink::FLAG_STRONGLINK> l_topology;
...
protected:
    ...
    ~TetrahedronViscoHyperelasticityFEMForceField() override;


    /// the array that describes the complete material properties of a specific Viscoelastic model
    std::unique_ptr<material::BaseViscoHyperelasticMaterial<DataTypes> > m_myMaterial;
...
#if  !defined(SOFA_COMPONENT_FORCEFIELD_TetrahedronViscoHyperelasticityFEMForceField_CPP)
extern template class SOFAVISCOELASTIC_API TetrahedronViscoHyperelasticityFEMForceField<defaulttype::Vec3Types>;
#endif //  !defined(SOFA_COMPONENT_FORCEFIELD_TetrahedronViscoHyperelasticityFEMForceField_CPP)
