...
public:
  ...
  MatrixSym Edev; //deviatoric part of strain tensor
  MatrixSym Eprev; //deviatoric strain tensor previous step
  ...
  StrainInformation() : trE(0), J(0), lambda(0), hasBeenInitialized(false), C(), logJ(0),E(), Edev(), Eprev() ,Evisc1(), Evisc_prev1(), Evisc2(), Evisc_prev2() {}
